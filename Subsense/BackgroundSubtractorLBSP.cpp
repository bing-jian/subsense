...
BackgroundSubtractorLBSP::BackgroundSubtractorLBSP(float fRelLBSPThreshold,
...
cv::Algorithm* BackgroundSubtractorLBSP::info() const { return nullptr; }

cv::Mat BackgroundSubtractorLBSP::getROICopy() const { return m_oROI.clone(); }
